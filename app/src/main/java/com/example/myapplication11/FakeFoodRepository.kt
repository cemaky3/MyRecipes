    ...
    companion object {
        fun getRecipes(): List<Recipe> {
            val frenchtoast = Recipe(
                1, "Французские тосты с клубникой", Meals.Breakfast, Dishes.MainDish, 17, 4,
                370, "370", rating = 2.0
            )
            val muffins = Recipe(
                2, "Маффины", Meals.Breakfast, Dishes.Dessert, 30, 2,
                250, "370", rating = 1.0
            )
            val salmon = Recipe(
                3, "Лосось", Meals.Dinner, Dishes.MainDish, 45, 3,
                315, "370", rating = 3.0
            )
            val pancakes = Recipe(
                4, "Блинчики", Meals.Breakfast, Dishes.MainDish, 15, 2,
                200, "370", rating = 5.0
            )
            val spaghetti = Recipe(
                5, "Спагетти", Meals.Lunch, Dishes.MainDish, 25, 2,
                500, "370", rating = 5.0
            )
